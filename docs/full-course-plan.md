...
| 5  | 2 | ZA  | 10-minute slide presentation (max 6 slides) |
...
| 7  | 2 | NR  | 10-minute live demo |
| 8  | 1 | TL  | 8-minute paper presentation |
| 8  | 2 | NR  | 10-minute slide presentation (max 6 slides) |
| 9  | 1 | NACV  | 10-minute slide presentation (max 6 slides) |
| 9  | 2 | ZA  | 10-minute live demo |
| 10 | 1 | IS  | 10-minute live demo |
| 10 | 2 | NR  | 8-minute paper presentation |
...
| Student | Slots | Weeks |
|---------|-------|-------|
| BA   | 3 | 2M1 (chalk talk), 6M1 (paper presentation), 11M1 (slide presentation) |
| TK   | 3 | 2M2 (live demo), 7M1 (slide presentation), 12M1 (paper discussion co-facilitator) |
| TL   | 3 | 3M1 (live demo), 8M1 (paper presentation), 12M1 (cross-cutting discussion) |
| NACV | 3 | 3M2 (chalk talk), 9M1 (slide presentation), 12M1 (cross-cutting discussion) |
| IS   | 3 | 4M1 (chalk talk), 10M1 (live demo), 13M1 (paper-writing opener) |
| AAAM | 3 | 4M2 (slide presentation), 11M2 (chalk talk), 13M2 (showcase-week opener) |
| NRN  | 3 | 5M1 (live demo), 12M1 (paper discussion co-facilitator), 13M1 (practice-talk co-presenter) |
| ZA   | 3 | 5M2 (slide presentation), 9M2 (live demo), 12M2 (chalk talk) |
| NR   | 3 | 7M2 (live demo), 8M2 (slide presentation), 10M2 (paper presentation) |
...
The instructor pre-loads a skeleton Jupyter notebook into the course GitHub repository (path: `docs/exercises/week02/meeting1_token_explorer.ipynb`). Students open it directly from the course site or clone the repository and open it locally.

📥 **[Download `meeting1_token_explorer.ipynb`](exercises/week02/meeting1_token_explorer.ipynb)**
...
- Course GitHub repository with skeleton notebook: `docs/exercises/week02/`
...
*Materials needed:* [`docs/exercises/week03/buggy_harmonic_oscillator.py`](exercises/week03/buggy_harmonic_oscillator.py) committed to the course GitHub repository; Python environment with numpy, scipy, matplotlib, and math pre-installed; whiteboard for tracking pair progress; printed or projected SciPy documentation for scipy.special.hermite
...
**Instructions:**
1. Clone the course repository and open `docs/exercises/week03/ai_generated_oscillator.py`. This script was produced by Claude with the prompt "Write a Python script that computes and plots the first five energy levels and wavefunctions of the quantum harmonic oscillator using numpy and scipy." Run the script using Python 3.10+ and record every error message and every output value. Do not fix anything yet — just observe. Write your observations in a markdown file named `week03_<lastname>_bugreport.md`.
...
- Course repository: [`docs/exercises/week03/ai_generated_oscillator.py`](exercises/week03/ai_generated_oscillator.py) — the AI-generated buggy script for this homework

📥 **[Download `ai_generated_oscillator.py`](exercises/week03/ai_generated_oscillator.py)**
...
*Materials needed:* Course GitHub repository with skeleton notebook [`docs/exercises/week04/rag_skeleton.ipynb`](exercises/week04/rag_skeleton.ipynb) and pre-fetched fallback corpus [`docs/exercises/week04/fallback_corpus.json`](exercises/week04/fallback_corpus.json); Python environment with arxiv, sentence-transformers, faiss-cpu, and either openai or anthropic installed; projector for instructor to display one working solution during debrief

📥 **[Download `rag_skeleton.ipynb`](exercises/week04/rag_skeleton.ipynb)** · **[Download `fallback_corpus.json`](exercises/week04/fallback_corpus.json)**
...
- Course repository skeleton notebook [`docs/exercises/week04/rag_skeleton.ipynb`](exercises/week04/rag_skeleton.ipynb) as a starting point

📥 **[Download `rag_skeleton.ipynb`](exercises/week04/rag_skeleton.ipynb)**
...
**Student Introduction** (assigned: ZA)
...
**Student Introduction** (assigned: NR)
